...
export function buildSystemPrompt(): string {
  ...
  return [
    ...
    "When the user asks to pin/save a finding, use `overcast finding create <text> --ref <record-id> --at <span> --target <target>`",
    "rather than a plain note, unless they explicitly ask for a note.",
    "",
