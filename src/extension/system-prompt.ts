...
export function buildSystemPrompt(): string {
  ...
  return [
    ...
    "create the right typed index when needed, and register collected media with",
    "`overcast index add --all --to <id>` after watch/listen/face/capture records are ready.",
