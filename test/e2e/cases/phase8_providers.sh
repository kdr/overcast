...
describe_ok "describe.web"        bash "$P/sources/web/web.sh"
describe_ok "describe.youtube"     bash "$P/sources/youtube/youtube.sh"
describe_ok "describe.tiktok"      bash "$P/sources/tiktok/tiktok.sh"
describe_ok "describe.x"           bash "$P/sources/x/x.sh"
